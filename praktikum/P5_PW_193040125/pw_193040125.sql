...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2020 at 01:44 PM
...
CREATE TABLE `apparel` (
  ...
  `nama Pakaian` varchar(20) NOT NULL,
  `Bahan Pakaian` varchar(100) NOT NULL,
...
INSERT INTO `apparel` (`no`, `foto`, `nama Pakaian`, `Bahan Pakaian`, `merk`, `harga`) VALUES
